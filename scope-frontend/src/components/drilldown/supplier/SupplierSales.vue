    ...
    <v-row no-gutters class='elevation-10 mx-1 main'>
      <v-col class='pa-2'>
        <div class='main-kpi'>
          ...
          <div class='kpi-big'>
            <span v-text="formatCurrency(sales.totalPurchased)"></span>
          </div>
        </div>
        <v-row class='secondary-kpis'>
          <v-col class='left-half secondary-kpis-container'>
            <div class='secondary-kpi'>
              ...
              <div class='kpi-big'>
                <span v-text="formatCurrency(sales.avgCostPerOrder)"></span>
              </div>
            </div>
            <div class='secondary-kpi'>
              <div class='kpi-label'>
                Pending Purchase Values
              </div>
              <div class='kpi-big'>
                <span v-text="formatCurrency(sales.pendingPurchaseValues)"></span>
              </div>
            </div>
          </v-col>
          <v-col class='right-half secondary-kpis-container'>
            ...
            <div class='secondary-kpi'>
              ...
              <div class='kpi-big'>
                <span v-text="formatCurrency(sales.purchaseBacklog)"></span>
              </div>
            </div>
          </v-col>
        </v-row>
